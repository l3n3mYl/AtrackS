  ...
  zoomAndSlideContent(Widget content) {
    ...
    switch (menuController.state) {
      ...
      case MenuState.closing:
        scalePercent = slideInCurve.transform(menuController.percentOpen);
        slidePercent = scaleUpCurve.transform(menuController.percentOpen);
        break;
      case MenuState.opening:
        scalePercent = slideOutCurve.transform(menuController.percentOpen);
        slidePercent = scaleDownCurve.transform(menuController.percentOpen);
        break;
    }
...
class _ZoomScaffoldMenuControllerState
  ...
  getMenuController(BuildContext context) {
    final _ZoomScaffoldState scaffoldState = context.
    findAncestorStateOfType<_ZoomScaffoldState>();
